<template>
    ...
    <div v-if="vueStore.loading == false" class="table">
        <div class="table_row" v-for="[key, group] in hubGroups">
            ...
            <div v-if="(group.Cost / group.Clicks)" class="table_row_item_bubble_wrapper">
                <div class="table_row_item_bubble">
                    {{ String((group.Cost / group.Clicks).toFixed(1)).replace(/(\d)(?=(\d{3})+([^\d]|$))/g, "$1 ") + ' ₽' }}
                </div>
            </div>
            <div class="table_row_item">
        ...
        <div class="table_footer">
            ...
            <div v-if="(vueStore.allCostValue / vueStore.allClicksValue)" class="table_row_item_bubble_wrapper">
                <div class="table_row_item_bubble">
                    {{ String((vueStore.allCostValue / vueStore.allClicksValue).toFixed(1)).replace(/(\d)(?=(\d{3})+([^\d]|$))/g, "$1 ") + ' ₽' }}
                </div>
            </div>
