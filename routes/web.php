...
Route::get('/yandex-direct-ads-info-10', function(Request $request) {
    $dateToday = date('Y-m-d', time());
    $dateStart = date('Y-m-d', strtotime("$dateToday -10 days"));
...
Route::get('/yandex-direct-ads-info', function(Request $request) {
    $ReportsURL = 'https://api.direct.yandex.com/json/v5/reports';
